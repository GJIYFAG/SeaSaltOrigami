...
Rectangle {
    ...
    anchors.fill: parent
    gradient: Gradient {
        GradientStop { position: 0.0; color: "#dff5f2" }
        GradientStop { position: 0.52; color: "#f8efd9" }
        GradientStop { position: 1.0; color: "#d6ebe7" }
    }
    ...
    Rectangle {
        ...
        radius: 8
        gradient: Gradient {
            GradientStop { position: 0.0; color: "#cfeeea" }
            GradientStop { position: 0.58; color: "#e4f3eb" }
            GradientStop { position: 1.0; color: "#f5e5c8" }
        }
        border.color: "#8dbeb8"
        border.width: 2
        ...
        Repeater {
            ...
            Rectangle {
                ...
                height: 2
                color: index % 2 === 0 ? "#ffffff" : "#d89982"
                opacity: index % 2 === 0 ? 0.26 : 0.11
            }
        }
